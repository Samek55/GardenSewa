...
// Edits another admin's allowed_cities scope (see list-gardener-applications'
// city-scoping for plain 'admin' role). Direct port of HomeSewa's
// update-admin-cities — Super Admin only, same gate as admin-create.
