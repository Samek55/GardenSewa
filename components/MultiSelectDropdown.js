...
// confirm/clear footer), now sharing its theme system too.
...
const createStyles = (colors) => StyleSheet.create({
    ...
    modalFooter: { flexDirection: 'row', gap: 12, padding: 16, borderTopWidth: 1, borderTopColor: colors.divider },
    clearBtn: { flex: 1, paddingVertical: 12, borderRadius: 14, borderWidth: 1.5, borderColor: colors.border, alignItems: 'center' },
    clearBtnText: { fontSize: 14, fontWeight: '700', color: colors.textMuted },
    confirmBtn: { flex: 2, paddingVertical: 12, borderRadius: 14, backgroundColor: colors.brand, alignItems: 'center' },
